...
class Backend(models.Model):
    ...
    """
    Model used to store references to backend implementations (as per coco-contract package).
    ...
    module = models.CharField(
        ...
        help_text='The full absolute module path (i.e. coco.backends.container_backends).'
    )
...
class Container(models.Model):
    ...
    def clone(self, name, description=None):
        ...
        from coco.core.signals.signals import container_cloned
    ...
    def commit(self, name, description=None, short_description=None, public=False):
        ...
        from coco.core.signals.signals import container_committed
    ...
    def restart(self):
        ...
        """
        from coco.core.signals.signals import container_restarted
    ...
    def resume(self):
        ...
        """
        from coco.core.signals.signals import container_resumed
    ...
    def start(self, *args):
        ...
        Start the container.
        """
        from coco.core.signals.signals import container_started
    ...
    def stop(self):
        ...
        Stop the container.
        """
        from coco.core.signals.signals import container_stopped
    ...
    def suspend(self):
        ...
        if self.is_running() and not self.is_suspended():
            from coco.core.signals.signals import container_suspended
...
class ContainerImage(models.Model):
    ...
    protected_port = models.PositiveIntegerField(
        ...
        This port is only accessable through the coco application for the container owner."""
    )
...
class ContainerSnapshot(models.Model):
    ...
    def restore(self):
        ...
        TODO: write doc.
        """
        from coco.core.signals.signals import container_snapshot_restored
...
class Server(models.Model):
    ...
    """
    Django model to represent an coco setup node.
    """
